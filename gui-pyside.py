...
import asyncio
import aiofiles
from PySide6.QtWidgets import QApplication, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QLabel, QFileDialog, QSizePolicy, QTextEdit, QSpacerItem, QMessageBox
from PySide6.QtGui import QPixmap, QIcon, QPalette, QColor, QFont, QPainter, QPolygon
from PySide6.QtCore import Qt, QProcess, QThread, Signal, QPoint
...
class KathanaVersionTool(QWidget):
    ...
    def initUI(self):
        ...
        version_selector_layout.addWidget(left_arrow_btn, alignment=Qt.Alignment.AlignLeft)

        self.selected_version_label = QLabel(KATHANA_DISPLAY_NAMES[self.selected_index])
        self.selected_version_label.setAlignment(Qt.Alignment.AlignCenter)
        ...
        version_selector_layout.addWidget(self.selected_version_label, alignment=Qt.Alignment.AlignCenter)

        right_arrow_btn = ArrowButton("right", hover_sound, click_sound, self)
        right_arrow_btn.clicked.connect(self.select_next_version)
        version_selector_layout.addWidget(right_arrow_btn, alignment=Qt.Alignment.AlignRight)
        ...
        console_palette.setColor(QPalette.ColorRole.Base, QColor(40, 42, 54, 255))
